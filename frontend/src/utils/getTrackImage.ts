export const getTrackImage = (gpName: string): string => {
  ...
  if (name.includes("bretaña") || name.includes("silverstone") || name.includes("britain") || name.includes("uk")) return "/tracks/britain.png";
  ...
  if (name.includes("madrid")) return "/tracks/madrid.png";
  if (name.includes("azerba") || name.includes("baku")) return "/tracks/baku.png";
  if (name.includes("singapur") || name.includes("singapore")) return "/tracks/singapore.png";
  if (name.includes("usa") || name.includes("austin")) return "/tracks/usa.png";
  if (name.includes("xico")) return "/tracks/mexico.png";
  if (name.includes("brasil") || name.includes("brazil")) return "/tracks/brazil.png";
