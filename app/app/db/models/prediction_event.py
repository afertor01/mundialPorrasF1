...
class PredictionEvents(SQLModel, table=True):
    ...
    event_type: str = Field(description="Tipo de evento, ('FASTEST_LAP', 'SAFETY_CAR', etc.)", nullable=False)
    value: str = Field(description="Valor del evento", nullable=False)       # Sí/No o número/piloto según evento
