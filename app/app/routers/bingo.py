...
class BingoRouter:
    ...
    def router(self) -> APIRouter:
        ...
        @api_router.post(
            "/tile",
            description="Create a new bingo tile",
            response_model=BingoTileResponse,
        ...
        @api_router.put(
            "/tile",
            description="Update an existing bingo tile",
            response_model=BingoTileResponse,
            dependencies=[Depends(require_admin)],
        )
        ...
        @api_router.delete(
            "/tile/{tile_id}",
            description="Delete an existing bingo tile",
        ...
        def get_my_bingo_board(
            bingo_service: BingoServiceDep, current_user=Depends(get_current_user)
        ):
