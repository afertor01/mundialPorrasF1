...
class PredictionsRouter:
    ...
    def router(self) -> APIRouter:
        ...
        @api_router.post(
            "/",
            description="Create or update a prediction for a GP",
        ...
        @api_router.get(
            "/{gp_id}/me",
            description="Get my prediction for a specific GP",
        ...
        @api_router.get(
            "/{gp_id}/all",
            description="Get all predictions for a specific GP",
            response_model=List[PredictionResponse],
        )
        def get_all_predictions_for_gp(
            gp_id: int, predictions_service: PredictionsServiceDep
